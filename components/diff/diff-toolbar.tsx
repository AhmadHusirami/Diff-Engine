...
import { Settings2, Download, Copy, Check, Type, Hash, SplitSquareHorizontal, AlignLeft, ChevronUp, ChevronDown } from 'lucide-react';
...
export function DiffToolbar({ onCopy, onExportTxt, onExportJson, diffResult }: { onCopy: () => void, onExportTxt: () => void, onExportJson: () => void, diffResult?: any }) {
  ...
  const scrollToDiff = (direction: 'next' | 'prev') => {
    ...
    // Find the first element that is below the current scroll position
    const scrollY = window.scrollY;
    const headerOffset = 150; // Approximate height of sticky headers
    ...
    if (direction === 'next') {
      targetIndex = changes.findIndex(el => {
        ...
        return rect.top > headerOffset + 10; // +10 for a little buffer
      });
      if (targetIndex === -1) targetIndex = 0; // Wrap around
    } else {
      // Find the last element that is above the current scroll position
      ...
      if (targetIndex === -1) targetIndex = changes.length - 1; // Wrap around
    }
                ...
                <div className="grid gap-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(c) => updateSettings({ wordLevelDiff: c })}
                    />
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(c) => updateSettings({ ignoreWhitespace: c })}
                    />
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(c) => updateSettings({ ignoreCase: c })}
                    />
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(c) => updateSettings({ collapseUnchanged: c })}
                    />
                  </div>
                  <div className="flex items-center justify-between">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={settings.syntaxTheme} onValueChange={(v) => updateSettings({ syntaxTheme: v as string })}>
                    <SelectTrigger className="h-9 bg-muted/50"><SelectValue /></SelectTrigger>
                    <SelectContent>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-2 p-1 border border-border rounded-md bg-muted/30">
                      <input 
                        ...
                        onChange={(e) => updateSettings({ colors: { ...settings.colors, addedBg: e.target.value + '33' } })}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-2 p-1 border border-border rounded-md bg-muted/30">
                      <input 
                        ...
                        onChange={(e) => updateSettings({ colors: { ...settings.colors, addedText: e.target.value } })}
                        className="w-6 h-6 p-0 border-0 rounded cursor-pointer"
                      />
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-2 p-1 border border-border rounded-md bg-muted/30">
                      <input 
                        ...
                        onChange={(e) => updateSettings({ colors: { ...settings.colors, removedBg: e.target.value + '33' } })}
                        className="w-6 h-6 p-0 border-0 rounded cursor-pointer"
                      />
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-2 p-1 border border-border rounded-md bg-muted/30">
                      <input 
                        ...
                        onChange={(e) => updateSettings({ colors: { ...settings.colors, removedText: e.target.value } })}
                        className="w-6 h-6 p-0 border-0 rounded cursor-pointer"
                      />
